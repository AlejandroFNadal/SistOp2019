...
class Ui_Estadistica1(object):
    def setupUi(self, Estadistica1):
        ...
        self.label_estadistica1 = QtWidgets.QLabel(self.centralwidget)
        self.label_estadistica1.setGeometry(QtCore.QRect(20, 10, 761, 511))
        self.label_estadistica1.setText("")
        self.label_estadistica1.setObjectName("label_estadistica1")
